...
def test_release_has_no_old_release_documents_or_backup_code():
    ...
    forbidden = {
        ...
        "DEPLOY_V2_0.txt",
        "V2_0_UPLOAD_LIST.txt",
        "V2_0_DELETE_LIST.txt",
        "V2_0_CHANGELOG.txt",
        "V2_0_TEST_REPORT.txt",
        "DEPLOY_V2_1.txt",
        "V2_1_UPLOAD_LIST.txt",
        "V2_1_DELETE_LIST.txt",
        "V2_1_CHANGELOG.txt",
        "V2_1_TEST_REPORT.txt",
        "DEPLOY_V2_5.txt",
        "V2_5_UPLOAD_LIST.txt",
        "V2_5_DELETE_LIST.txt",
        "V2_5_CHANGELOG.txt",
        "V2_5_TEST_REPORT.txt",
        "app_old.py",
        "backup.py",
    }
